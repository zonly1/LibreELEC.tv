...
{
  ///////////////////////////////////////////////////////////////////////////////////////////////////
  AMLImageDecoder::AMLImageDecoder(AlphaOption alphaOption,
...
/*    if (!m_decoder)
  ...
  ///////////////////////////////////////////////////////////////////////////////////////////////////
  void AMLImageDecoder::decodeHW(RefPtr<SharedBuffer> inputData, ImageFrame& outputBuffer, int outWidth, int outHeight)
  {
/*
    clock_t start = clock();
  ...
  ///////////////////////////////////////////////////////////////////////////////////////////////////
  void AMLImageDecoder::log(const char * format, ...)
  {
    if (!logFile)
    {
    ...
    fprintf(logFile, "AMLImageDecoder(jpg):");
