...
PKG_DEPENDS_TARGET="toolchain systemd fontconfig qt5 libcec mpv SDL2 libXdmcp breakpad breakpad:host libconnman-qt ${MEDIACENTER,,}-fonts-ttf  fc-cache strace"
